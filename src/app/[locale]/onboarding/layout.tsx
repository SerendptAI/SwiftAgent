    ...
    <AuthGuard>
      <div className="grid h-screen w-full overflow-hidden bg-[#F6F6F6] md:grid-cols-[105px_1fr]">
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          <Header />
          <main className="flex min-h-0 flex-1 gap-4 overflow-hidden p-4 lg:gap-6 lg:p-6">
            <div className="min-h-0 flex-1 overflow-y-auto rounded-3xl border border-gray-100 bg-white p-6 shadow-sm">
              {children}
            </div>
