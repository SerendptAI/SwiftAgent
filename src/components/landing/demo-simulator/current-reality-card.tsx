...
export function CurrentRealityCard({
  ...
  return (
    <div className="bg-white p-6 shadow-[-4px_4px_0px_0px_#000000] md:px-8.5 md:pt-5.5 md:pb-8">
      <div className="mb-8">
        <span className="text-base leading-[1.6] tracking-[10%] text-black/60 uppercase md:text-lg">
          {t("badge")}
        </span>
      </div>

      <h3 className="mb-8 text-lg leading-[1.6] font-medium tracking-[2%] capitalize md:text-xl">
        {t("title")}
      </h3>
      ...
      <p className="px-2.5 text-sm leading-[1.8] tracking-[2%] text-black/80">
        {t("note")}
      </p>
    </div>
  );
