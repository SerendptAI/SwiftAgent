...
export function AutomatedSystemCard({
  ...
  return (
    <div className="bg-white p-6 shadow-[-4px_4px_0px_0px_#000000] md:px-8.5 md:pt-5.5 md:pb-8">
      <div className="mb-8 flex flex-col text-base leading-[1.6] tracking-[2%] md:flex-row md:items-center md:justify-between md:text-lg">
        <span className="text-black/60 uppercase">{t("badge")}</span>
        <span className="text-black capitalize">
          {t("automatedPercent", { rate: repetitiveRate })}
        </span>
      </div>

      <h3 className="mb-8 text-lg leading-[1.6] font-medium tracking-[2%] text-black capitalize md:text-xl">
        {t("title")}
      </h3>

      <div className="mb-8 divide-y divide-black/37 border-b border-black/37 text-sm leading-normal tracking-[2%] text-black/80 sm:text-base">
      ...
      <div className="flex items-center justify-between gap-3 bg-[#F2B035] p-4 leading-normal tracking-[2%] text-black shadow-[-4px_4px_0px_0px_#000000] md:px-6 md:py-5">
