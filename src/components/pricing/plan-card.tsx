  ...
  return (
    ...
    >
      ...
      <div className="font-dm-mono flex min-w-0 flex-1 flex-col px-4 pt-4 md:px-6 md:pt-6">
        <h3
          className={`mb-3 text-sm leading-none tracking-widest uppercase md:mb-3.5 md:text-base ${plan.textColor}`}
        >
          {plan.name}
        </h3>

        <p className="mb-3 text-sm leading-none text-gray-900 md:mb-3.5 md:text-base">
